...
class I2SAudioSpeakerBase : public I2SAudioOut, public speaker::Speaker, public Component {
 ...
 protected:
  ...
  /// @brief Duplex-Bus: leiht den bereits TDM-initialisierten TX-Kanal des Busses
  /// statt einen eigenen zu erzeugen; richtet nur die Event-Queues ein.
  /// Der Kanal bleibt im READY-Zustand (Preload + Enable macht der Speaker-Task wie gewohnt).
  esp_err_t borrow_i2s_channel_(size_t event_queue_size);
